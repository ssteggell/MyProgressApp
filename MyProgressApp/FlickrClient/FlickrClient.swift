...
class FlickrClient {
    ...
    func getPhotoUrl(page: Int, completion: @escaping ([FlickrPhoto]?, Error?) -> Void) {
        ...
        let tags = URLQueryItem(name: "tags", value: "bodybuilding, weightloss")
        ...
        components.queryItems = [api, method, format, tags, jsonCallback, perPage, page]
